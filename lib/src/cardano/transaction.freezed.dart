...
mixin _$CardanoTransaction {
  ...
  $CardanoTransactionCopyWith<CardanoTransaction> get copyWith =>
      _$CardanoTransactionCopyWithImpl<CardanoTransaction>(
          this as CardanoTransaction, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CardanoTransaction &&
            (identical(other.body, body) || other.body == body) &&
            (identical(other.witnessSet, witnessSet) ||
                other.witnessSet == witnessSet) &&
            (identical(other.isValidDi, isValidDi) ||
                other.isValidDi == isValidDi) &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, body, witnessSet, isValidDi, auxiliaryData);
...
abstract mixin class $CardanoTransactionCopyWith<$Res> {
  factory $CardanoTransactionCopyWith(
          CardanoTransaction value, $Res Function(CardanoTransaction) _then) =
      _$CardanoTransactionCopyWithImpl;
  @useResult
  $Res call(
      {CardanoTransactionBody body,
...
class _$CardanoTransactionCopyWithImpl<$Res>
  ...
  $Res call({
    Object? body = null,
    Object? witnessSet = null,
    Object? isValidDi = null,
    ...
    return _then(_self.copyWith(
      body: null == body
          ...
          : body // ignore: cast_nullable_to_non_nullable
              as CardanoTransactionBody,
      witnessSet: null == witnessSet
          ? _self.witnessSet
          : witnessSet // ignore: cast_nullable_to_non_nullable
              as WitnessSet,
      isValidDi: null == isValidDi
          ? _self.isValidDi
          : isValidDi // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _CardanoTransaction extends CardanoTransaction {
  const _CardanoTransaction(
      {required this.body,
      required this.witnessSet,
      required this.isValidDi,
      required this.auxiliaryData})
      : super._();

  @override
  final CardanoTransactionBody body;
// 0
  @override
  final WitnessSet witnessSet;
// 1
  @override
  final bool isValidDi;
// 2
  @override
  final CBORMetadata? auxiliaryData;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CardanoTransactionCopyWith<_CardanoTransaction> get copyWith =>
      __$CardanoTransactionCopyWithImpl<_CardanoTransaction>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _CardanoTransaction &&
            (identical(other.body, body) || other.body == body) &&
            (identical(other.witnessSet, witnessSet) ||
                other.witnessSet == witnessSet) &&
            (identical(other.isValidDi, isValidDi) ||
...
/// @nodoc
abstract mixin class _$CardanoTransactionCopyWith<$Res>
    implements $CardanoTransactionCopyWith<$Res> {
  factory _$CardanoTransactionCopyWith(
          _CardanoTransaction value, $Res Function(_CardanoTransaction) _then) =
      __$CardanoTransactionCopyWithImpl;
  @override
  @useResult
  $Res call(
      {CardanoTransactionBody body,
