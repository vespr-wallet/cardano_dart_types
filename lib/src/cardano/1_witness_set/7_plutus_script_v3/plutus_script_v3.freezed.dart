...
$PlutusScriptV3CopyWith<PlutusScriptV3> get copyWith => _$PlutusScriptV3CopyWithImpl<PlutusScriptV3>(this as PlutusScriptV3, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PlutusScriptV3&&const DeepCollectionEquality().equals(other.bytes, bytes));
}
...
abstract mixin class $PlutusScriptV3CopyWith<$Res>  {
  factory $PlutusScriptV3CopyWith(PlutusScriptV3 value, $Res Function(PlutusScriptV3) _then) = _$PlutusScriptV3CopyWithImpl;
@useResult
$Res call({
 Uint8List bytes
});
...
@pragma('vm:prefer-inline')
_$PlutusScriptV3CopyWith<_PlutusScriptV3> get copyWith => __$PlutusScriptV3CopyWithImpl<_PlutusScriptV3>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PlutusScriptV3&&const DeepCollectionEquality().equals(other.bytes, bytes));
}
...
/// @nodoc
abstract mixin class _$PlutusScriptV3CopyWith<$Res> implements $PlutusScriptV3CopyWith<$Res> {
  factory _$PlutusScriptV3CopyWith(_PlutusScriptV3 value, $Res Function(_PlutusScriptV3) _then) = __$PlutusScriptV3CopyWithImpl;
@override @useResult
$Res call({
 Uint8List bytes
});
