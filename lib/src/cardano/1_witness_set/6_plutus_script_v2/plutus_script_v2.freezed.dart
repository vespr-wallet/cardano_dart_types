...
$PlutusScriptV2CopyWith<PlutusScriptV2> get copyWith => _$PlutusScriptV2CopyWithImpl<PlutusScriptV2>(this as PlutusScriptV2, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PlutusScriptV2&&const DeepCollectionEquality().equals(other.bytes, bytes));
}
...
abstract mixin class $PlutusScriptV2CopyWith<$Res>  {
  factory $PlutusScriptV2CopyWith(PlutusScriptV2 value, $Res Function(PlutusScriptV2) _then) = _$PlutusScriptV2CopyWithImpl;
@useResult
$Res call({
 Uint8List bytes
});
...
@pragma('vm:prefer-inline')
_$PlutusScriptV2CopyWith<_PlutusScriptV2> get copyWith => __$PlutusScriptV2CopyWithImpl<_PlutusScriptV2>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PlutusScriptV2&&const DeepCollectionEquality().equals(other.bytes, bytes));
}
...
/// @nodoc
abstract mixin class _$PlutusScriptV2CopyWith<$Res> implements $PlutusScriptV2CopyWith<$Res> {
  factory _$PlutusScriptV2CopyWith(_PlutusScriptV2 value, $Res Function(_PlutusScriptV2) _then) = __$PlutusScriptV2CopyWithImpl;
@override @useResult
$Res call({
 Uint8List bytes
});
