...
mixin _$WitnessBootstrap {
 ...
 Uint8List get publicKey; Uint8List get signature; Uint8List get chainCode; Uint8List get attributes;
/// Create a copy of WitnessBootstrap
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$WitnessBootstrapCopyWith<WitnessBootstrap> get copyWith => _$WitnessBootstrapCopyWithImpl<WitnessBootstrap>(this as WitnessBootstrap, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WitnessBootstrap&&const DeepCollectionEquality().equals(other.publicKey, publicKey)&&const DeepCollectionEquality().equals(other.signature, signature)&&const DeepCollectionEquality().equals(other.chainCode, chainCode)&&const DeepCollectionEquality().equals(other.attributes, attributes));
}
...
abstract mixin class $WitnessBootstrapCopyWith<$Res>  {
  factory $WitnessBootstrapCopyWith(WitnessBootstrap value, $Res Function(WitnessBootstrap) _then) = _$WitnessBootstrapCopyWithImpl;
@useResult
$Res call({
...
as Uint8List,chainCode: null == chainCode ? _self.chainCode : chainCode // ignore: cast_nullable_to_non_nullable
as Uint8List,attributes: null == attributes ? _self.attributes : attributes // ignore: cast_nullable_to_non_nullable
as Uint8List,
  ));
}
...
class _WitnessBootstrap extends WitnessBootstrap {
  const _WitnessBootstrap({required this.publicKey, required this.signature, required this.chainCode, required this.attributes}): super._();
...
@pragma('vm:prefer-inline')
_$WitnessBootstrapCopyWith<_WitnessBootstrap> get copyWith => __$WitnessBootstrapCopyWithImpl<_WitnessBootstrap>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WitnessBootstrap&&const DeepCollectionEquality().equals(other.publicKey, publicKey)&&const DeepCollectionEquality().equals(other.signature, signature)&&const DeepCollectionEquality().equals(other.chainCode, chainCode)&&const DeepCollectionEquality().equals(other.attributes, attributes));
}
...
/// @nodoc
abstract mixin class _$WitnessBootstrapCopyWith<$Res> implements $WitnessBootstrapCopyWith<$Res> {
  factory _$WitnessBootstrapCopyWith(_WitnessBootstrap value, $Res Function(_WitnessBootstrap) _then) = __$WitnessBootstrapCopyWithImpl;
@override @useResult
$Res call({
 Uint8List publicKey, Uint8List signature, Uint8List chainCode, Uint8List attributes
});
...
/// Create a copy of WitnessBootstrap
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? publicKey = null,Object? signature = null,Object? chainCode = null,Object? attributes = null,}) {
