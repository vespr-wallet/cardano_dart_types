...
mixin _$ProposalProcedure {
 ...
 CborInt get deposit; Uint8List get rewardAccount; GovAction get govAction; Anchor get anchor; CborLengthType get cborLengthType;
/// Create a copy of ProposalProcedure
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ProposalProcedureCopyWith<ProposalProcedure> get copyWith => _$ProposalProcedureCopyWithImpl<ProposalProcedure>(this as ProposalProcedure, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProposalProcedure&&(identical(other.deposit, deposit) || other.deposit == deposit)&&const DeepCollectionEquality().equals(other.rewardAccount, rewardAccount)&&(identical(other.govAction, govAction) || other.govAction == govAction)&&(identical(other.anchor, anchor) || other.anchor == anchor)&&(identical(other.cborLengthType, cborLengthType) || other.cborLengthType == cborLengthType));
}
...
abstract mixin class $ProposalProcedureCopyWith<$Res>  {
  factory $ProposalProcedureCopyWith(ProposalProcedure value, $Res Function(ProposalProcedure) _then) = _$ProposalProcedureCopyWithImpl;
@useResult
$Res call({
...
as CborInt,rewardAccount: null == rewardAccount ? _self.rewardAccount : rewardAccount // ignore: cast_nullable_to_non_nullable
as Uint8List,govAction: null == govAction ? _self.govAction : govAction // ignore: cast_nullable_to_non_nullable
as GovAction,anchor: null == anchor ? _self.anchor : anchor // ignore: cast_nullable_to_non_nullable
as Anchor,cborLengthType: null == cborLengthType ? _self.cborLengthType : cborLengthType // ignore: cast_nullable_to_non_nullable
as CborLengthType,
  ));
}
/// Create a copy of ProposalProcedure
...
class _ProposalProcedure extends ProposalProcedure {
  const _ProposalProcedure({required this.deposit, required this.rewardAccount, required this.govAction, required this.anchor, this.cborLengthType = CborLengthType.auto}): super._();
...
@pragma('vm:prefer-inline')
_$ProposalProcedureCopyWith<_ProposalProcedure> get copyWith => __$ProposalProcedureCopyWithImpl<_ProposalProcedure>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProposalProcedure&&(identical(other.deposit, deposit) || other.deposit == deposit)&&const DeepCollectionEquality().equals(other.rewardAccount, rewardAccount)&&(identical(other.govAction, govAction) || other.govAction == govAction)&&(identical(other.anchor, anchor) || other.anchor == anchor)&&(identical(other.cborLengthType, cborLengthType) || other.cborLengthType == cborLengthType));
}
...
/// @nodoc
abstract mixin class _$ProposalProcedureCopyWith<$Res> implements $ProposalProcedureCopyWith<$Res> {
  factory _$ProposalProcedureCopyWith(_ProposalProcedure value, $Res Function(_ProposalProcedure) _then) = __$ProposalProcedureCopyWithImpl;
@override @useResult
$Res call({
 CborInt deposit, Uint8List rewardAccount, GovAction govAction, Anchor anchor, CborLengthType cborLengthType
});
...
/// Create a copy of ProposalProcedure
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? deposit = null,Object? rewardAccount = null,Object? govAction = null,Object? anchor = null,Object? cborLengthType = null,}) {
