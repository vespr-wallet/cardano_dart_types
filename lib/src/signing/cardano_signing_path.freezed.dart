...
class $CardanoSigningPathCopyWith<$Res> {
  $CardanoSigningPathCopyWith(
      CardanoSigningPath _, $Res Function(CardanoSigningPath) __);
}

/// @nodoc

class CardanoSigningPath_Byron extends CardanoSigningPath {
  CardanoSigningPath_Byron({required this.account, required this.address})
      : super._();
  ...
  $CardanoSigningPath_ByronCopyWith<CardanoSigningPath_Byron> get copyWith =>
      _$CardanoSigningPath_ByronCopyWithImpl<CardanoSigningPath_Byron>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CardanoSigningPath_Byron &&
...
/// @nodoc
abstract mixin class $CardanoSigningPath_ByronCopyWith<$Res>
    implements $CardanoSigningPathCopyWith<$Res> {
  factory $CardanoSigningPath_ByronCopyWith(CardanoSigningPath_Byron value,
          $Res Function(CardanoSigningPath_Byron) _then) =
      _$CardanoSigningPath_ByronCopyWithImpl;
  @useResult
...
class CardanoSigningPath_Shelley extends CardanoSigningPath {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $CardanoSigningPath_ShelleyCopyWith<CardanoSigningPath_Shelley>
      get copyWith =>
          _$CardanoSigningPath_ShelleyCopyWithImpl<CardanoSigningPath_Shelley>(
              this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CardanoSigningPath_Shelley &&
            (identical(other.account, account) || other.account == account) &&
            (identical(other.address, address) || other.address == address) &&
...
/// @nodoc
abstract mixin class $CardanoSigningPath_ShelleyCopyWith<$Res>
    implements $CardanoSigningPathCopyWith<$Res> {
  factory $CardanoSigningPath_ShelleyCopyWith(CardanoSigningPath_Shelley value,
          $Res Function(CardanoSigningPath_Shelley) _then) =
      _$CardanoSigningPath_ShelleyCopyWithImpl;
  @useResult
  $Res call({int account, int address, Bip32KeyRole role});
}
...
class CardanoSigningPath_CIP36 extends CardanoSigningPath {
  CardanoSigningPath_CIP36({required this.account, required this.address})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $CardanoSigningPath_CIP36CopyWith<CardanoSigningPath_CIP36> get copyWith =>
      _$CardanoSigningPath_CIP36CopyWithImpl<CardanoSigningPath_CIP36>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CardanoSigningPath_CIP36 &&
            (identical(other.account, account) || other.account == account) &&
            (identical(other.address, address) || other.address == address));
  }
...
/// @nodoc
abstract mixin class $CardanoSigningPath_CIP36CopyWith<$Res>
    implements $CardanoSigningPathCopyWith<$Res> {
  factory $CardanoSigningPath_CIP36CopyWith(CardanoSigningPath_CIP36 value,
          $Res Function(CardanoSigningPath_CIP36) _then) =
      _$CardanoSigningPath_CIP36CopyWithImpl;
  @useResult
  $Res call({int account, int address});
}
...
class CardanoSigningPath_Custom extends CardanoSigningPath {
  CardanoSigningPath_Custom({required final List<int> path})
      : _path = path,
        super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $CardanoSigningPath_CustomCopyWith<CardanoSigningPath_Custom> get copyWith =>
      _$CardanoSigningPath_CustomCopyWithImpl<CardanoSigningPath_Custom>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CardanoSigningPath_Custom &&
...
/// @nodoc
abstract mixin class $CardanoSigningPath_CustomCopyWith<$Res>
    implements $CardanoSigningPathCopyWith<$Res> {
  factory $CardanoSigningPath_CustomCopyWith(CardanoSigningPath_Custom value,
          $Res Function(CardanoSigningPath_Custom) _then) =
      _$CardanoSigningPath_CustomCopyWithImpl;
  @useResult
