...
mixin _$ProposalDiffInfo {
 ...
 GovActionId get proposalId; GovAction get proposal;
/// Create a copy of ProposalDiffInfo
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ProposalDiffInfoCopyWith<ProposalDiffInfo> get copyWith => _$ProposalDiffInfoCopyWithImpl<ProposalDiffInfo>(this as ProposalDiffInfo, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProposalDiffInfo&&(identical(other.proposalId, proposalId) || other.proposalId == proposalId)&&(identical(other.proposal, proposal) || other.proposal == proposal));
}
...
abstract mixin class $ProposalDiffInfoCopyWith<$Res>  {
  factory $ProposalDiffInfoCopyWith(ProposalDiffInfo value, $Res Function(ProposalDiffInfo) _then) = _$ProposalDiffInfoCopyWithImpl;
@useResult
$Res call({
...
as GovActionId,proposal: null == proposal ? _self.proposal : proposal // ignore: cast_nullable_to_non_nullable
as GovAction,
  ));
}
/// Create a copy of ProposalDiffInfo
...
class _ProposalDiffInfo extends ProposalDiffInfo {
  const _ProposalDiffInfo({required this.proposalId, required this.proposal}): super._();
...
@pragma('vm:prefer-inline')
_$ProposalDiffInfoCopyWith<_ProposalDiffInfo> get copyWith => __$ProposalDiffInfoCopyWithImpl<_ProposalDiffInfo>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProposalDiffInfo&&(identical(other.proposalId, proposalId) || other.proposalId == proposalId)&&(identical(other.proposal, proposal) || other.proposal == proposal));
}
...
/// @nodoc
abstract mixin class _$ProposalDiffInfoCopyWith<$Res> implements $ProposalDiffInfoCopyWith<$Res> {
  factory _$ProposalDiffInfoCopyWith(_ProposalDiffInfo value, $Res Function(_ProposalDiffInfo) _then) = __$ProposalDiffInfoCopyWithImpl;
@override @useResult
$Res call({
 GovActionId proposalId, GovAction proposal
});
...
/// Create a copy of ProposalDiffInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? proposalId = null,Object? proposal = null,}) {
