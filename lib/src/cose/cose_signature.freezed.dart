...
mixin _$CoseSignature {
  ...
  $CoseSignatureCopyWith<CoseSignature> get copyWith =>
      _$CoseSignatureCopyWithImpl<CoseSignature>(
          this as CoseSignature, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CoseSignature &&
  ...
  int get hashCode => Object.hash(
      runtimeType, headers, const DeepCollectionEquality().hash(signature));
...
abstract mixin class $CoseSignatureCopyWith<$Res> {
  factory $CoseSignatureCopyWith(
          CoseSignature value, $Res Function(CoseSignature) _then) =
      _$CoseSignatureCopyWithImpl;
  @useResult
  $Res call({CoseHeaders headers, Uint8List signature});
...
class _CoseSignature extends CoseSignature {
  const _CoseSignature({required this.headers, required this.signature})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CoseSignatureCopyWith<_CoseSignature> get copyWith =>
      __$CoseSignatureCopyWithImpl<_CoseSignature>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _CoseSignature &&
            (identical(other.headers, headers) || other.headers == headers) &&
            const DeepCollectionEquality().equals(other.signature, signature));
  }
...
/// @nodoc
abstract mixin class _$CoseSignatureCopyWith<$Res>
    implements $CoseSignatureCopyWith<$Res> {
  factory _$CoseSignatureCopyWith(
          _CoseSignature value, $Res Function(_CoseSignature) _then) =
      __$CoseSignatureCopyWithImpl;
  @override
  @useResult
  $Res call({CoseHeaders headers, Uint8List signature});
