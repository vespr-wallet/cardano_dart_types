...
AddressInfo_Byron _$AddressInfo_ByronFromJson(Map json) =>
    AddressInfo_Byron($type: json['runtimeType'] as String?);
...
AddressInfo_Invalid _$AddressInfo_InvalidFromJson(Map json) =>
    AddressInfo_Invalid($type: json['runtimeType'] as String?);
...
AddressInfo_NotAnAddress _$AddressInfo_NotAnAddressFromJson(Map json) =>
    AddressInfo_NotAnAddress($type: json['runtimeType'] as String?);
...
StakeAddressInfo_NotAnAddress _$StakeAddressInfo_NotAnAddressFromJson(
  Map json,
) => StakeAddressInfo_NotAnAddress($type: json['runtimeType'] as String?);
